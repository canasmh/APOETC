...
def localtime_to_lst(local, mdt=True, latitude='32.7803', longitude='-108.8203'):
    """
    ...
    utc = "{}/{}/{} {}:{}".format(year, month, day, hour, minute)
    ...
    return apo.sidereal_time()


def equatorial_to_horizontal(declination, right_ascension, local_sidereal_time, observers_latitude='32.7803'):
...
def flux_to_countrate(flux):
    """Simple function that converts flux (in cgs) per wavelength to count rates
    :param flux:
    :return:
    """
